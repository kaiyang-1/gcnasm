...
template __global__ void gqa_kernel<opus_gqa_traits<32, 64, 128, 128, 8, false>>(opus_gqa_kargs);
template __global__ void gqa_kernel<opus_gqa_traits<32, 64, 192, 128, 8, false>>(opus_gqa_kargs);
#else
