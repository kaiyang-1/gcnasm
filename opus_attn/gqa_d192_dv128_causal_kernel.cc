// GQA flash attention kernel — D=192, D_V=128, causal instantiation
...
template __global__ void gqa_d192_dv128_kernel<opus_gqa_traits<32, 64, 192, 128, 8, true>>(opus_gqa_kargs);
#else
